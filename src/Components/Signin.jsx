  ...
  return (
    ...
    <div className="text-center text-purple-100 text-sm">
      ...
      onClick={() => setpagetoggle(!pagetoggle)}
        ...
        className="font-semibold text-pink-100 hover:text-pink-2 00 hover:underline focus:outline-none"
      >
        Sign Up
      </button>
    </div>
